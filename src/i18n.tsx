...
const translations: Record<string, Record<string, string>> = {
 en: {
  ...
  'hero.description': 'Buy Sand Cheats — private Legit cheats, wallhack, and loot overlays for SAND: Raiders of Sophie. Patch updates, English & Russian menu, Discord support.',
  'hero.cta': 'Purchase Now',
  'hero.features': 'See Features',
  'hero.trust': 'Windows 10 & 11 · Steam · Easy Anti-Cheat · External',
  'meta.title': 'Sand Cheats | SAND Raiders of Sophie Cheats',
