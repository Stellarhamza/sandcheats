...
export const SHARE_REDDIT = `https://www.reddit.com/submit?url=${encodeURIComponent(`${SITE_URL}/`)}&title=${encodeURIComponent(SHARE_TITLE)}`;
export const SHARE_DISCORD = 'https://discord.gg/zadeyo';
